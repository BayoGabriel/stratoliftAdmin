...
export default function EditProjectPage({ params }) {
    ...
    async function fetchProject() {
      try {
        ...
        if (result.success) {
          ...
          setSupplier(result.data.supplier || "Pumalift")
          setNumberOfStops(result.data.numberOfStops || 2)
  ...
  // Update stops when numberOfStops changes
  useEffect(() => {
    if (project && numberOfStops !== project.stops?.length) {
      let newStops = [...(project.stops || [])]

      if (numberOfStops > newStops.length) {
        // Add new stops
        for (let i = newStops.length; i < numberOfStops; i++) {
          newStops.push({
            floorNumber: i,
            height: 0,
            description: `Floor ${i}`,
      ...
      } else if (numberOfStops < newStops.length) {
        // Remove excess stops
        newStops = newStops.slice(0, numberOfStops)
      }

      setStops(newStops)
    }
  }, [numberOfStops, project])
  ...
  return (
    <div className="container mx-auto py-8 px-4">
      <div className="flex items-center mb-6">
        ...
        <h1 className="text-3xl font-bold ml-4">Edit Project</h1>
      </div>
        ...
        {activeTab === "basic" && (
          <div className="bg-white rounded-lg shadow">
            <div className="p-6 border-b">
              ...
              <p className="text-sm text-gray-500">Update the basic details for your project.</p>
            </div>
            <div className="p-6 space-y-6">
              ...
              <div className="space-y-2">
                ...
                <input
                  ...
                  defaultValue={project.assignedUsers?.map((user) => user._id || user).join(", ") || ""}
                  className="mt-1 block w-full border border-gray-300 rounded-md shadow-sm py-2 px-3 focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm"
                />
        ...
        {activeTab === "technical" && (
          <div className="bg-white rounded-lg shadow">
            <div className="p-6 border-b">
              ...
              <p className="text-sm text-gray-500">Update the technical specifications for this project.</p>
            </div>
            <div className="p-6 space-y-6">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="space-y-2">
                ...
                {supplier === "Other" && (
                  <div className="space-y-2">
                    ...
                    <input
                      id="otherSupplier"
                      name="otherSupplier"
                      defaultValue={project.otherSupplier || ""}
                      className="mt-1 block w-full border border-gray-300 rounded-md shadow-sm py-2 px-3 focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm"
                    />
                  </div>
                )}
                ...
                <div className="space-y-2">
                  ...
                  <input
                    ...
                    type="number"
                    min="0"
                    defaultValue={project.shaftWidth || ""}
                    className="mt-1 block w-full border border-gray-300 rounded-md shadow-sm py-2 px-3 focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm"
                  />
                </div>
                ...
                <div className="space-y-2">
                  ...
                  <input
                    ...
                    type="number"
                    min="0"
                    defaultValue={project.shaftDepth || ""}
                    className="mt-1 block w-full border border-gray-300 rounded-md shadow-sm py-2 px-3 focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm"
                  />
                </div>
                    ...
                    <div key={index} className="grid grid-cols-1 md:grid-cols-2 gap-4 p-4 border rounded-md">
                      <div className="space-y-2">
                        ...
                        <input
                          ...
                          min="0"
                          value={stop.height || 0}
                          onChange={(e) => handleStopChange(index, "height", e.target.value)}
                          className="mt-1 block w-full border border-gray-300 rounded-md shadow-sm py-2 px-3 focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm"
                        />
                      </div>
                      <div className="space-y-2">
                        ...
                        <input
                          ...
                          value={stop.description || `Floor ${index}`}
        ...
        {activeTab === "financial" && (
          <div className="bg-white rounded-lg shadow">
            <div className="p-6 border-b">
              ...
              <p className="text-sm text-gray-500">Update the financial information for this project.</p>
            </div>
            <div className="p-6 space-y-6">
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                <div className="space-y-2">
                  ...
                  <input
                    ...
                    min="0"
                    step="0.01"
                    defaultValue={project.costOfPurchase || ""}
                    className="mt-1 block w-full border border-gray-300 rounded-md shadow-sm py-2 px-3 focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm"
                  />
                </div>
                ...
                <div className="space-y-2">
                  ...
                  <input
                    ...
                    min="0"
                    step="0.01"
                    defaultValue={project.costOfInstallation || ""}
                    className="mt-1 block w-full border border-gray-300 rounded-md shadow-sm py-2 px-3 focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm"
                  />
                </div>
                ...
                <div className="space-y-2">
                  ...
                  <input
                    ...
                    min="0"
                    step="0.01"
                    defaultValue={project.customerCharge || ""}
                    className="mt-1 block w-full border border-gray-300 rounded-md shadow-sm py-2 px-3 focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm"
                  />
                </div>
              </div>
              ...
              <div className="space-y-2">
                ...
                <textarea
                  ...
                  name="financialNotes"
                  rows={4}
                  defaultValue={project.financialNotes || ""}
                  className="mt-1 block w-full border border-gray-300 rounded-md shadow-sm py-2 px-3 focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm"
                />
              </div>
            </div>
        ...
        {activeTab === "customer" && (
          <div className="bg-white rounded-lg shadow">
            <div className="p-6 border-b">
              ...
              <p className="text-sm text-gray-500">Update the customer details for this project.</p>
            </div>
            <div className="p-6 space-y-6">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="space-y-2">
                  ...
                  <input
                    ...
                    defaultValue={project.customerContact?.name || ""}
                    className="mt-1 block w-full border border-gray-300 rounded-md shadow-sm py-2 px-3 focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm"
                  />
                </div>
                ...
                <div className="space-y-2">
                  ...
                  <input
                    ...
                    type="email"
                    defaultValue={project.customerContact?.email || ""}
                    className="mt-1 block w-full border border-gray-300 rounded-md shadow-sm py-2 px-3 focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm"
                  />
                </div>
                ...
                <div className="space-y-2">
                  ...
                  <input
                    ...
                    defaultValue={project.customerContact?.phone || ""}
                    className="mt-1 block w-full border border-gray-300 rounded-md shadow-sm py-2 px-3 focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm"
                  />
                </div>
                ...
                <div className="space-y-2">
                  ...
                  <input
                    ...
                    defaultValue={project.customerContact?.address || ""}
                    className="mt-1 block w-full border border-gray-300 rounded-md shadow-sm py-2 px-3 focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm"
                  />
                </div>
              </div>
